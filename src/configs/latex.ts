export const FORMULA_LIST = [
  ...
  {
    label: 'Benuli equation',
    latex: `\\frac {dy} {dx} + P(x)y = Q(x) y^n ({n} \\not= {0,1})`,
  },
  {
    label: 'Full Micro-Equal',
    latex: `du(x,y) = P(x,y)dx + Q(x,y)dy = 0`,
  },
  {
    label: 'Non-Synchronous Equation',
  ...
  {
    label: 'LaGrand medium-value theorem',
  ...
  {
    label: 'Second degree differentials.',
