...
export default () => {
  ...
  // Delete current page，If all pages will be deleted，then perform the reset slide operation
  ...
  // Copy and delete the current page（cut）
  // Due to the copy operation, the multi-select state will disappear，Therefore, the pages that need to be deleted need to be deleted in advanceIDCaching
  const cutSlide = () => {
  ...
  // Drag and drop to adjust slide order and synchronize data
