...
export default () => {
  ...
  // Create (insert) an element and mark it as selected
   ...
   * @param position Position and size metadata.
   ...
   * @param position Position and size metadata.
   * @param data Shape path configuration.
   */
   ...
   * @param position Position and size metadata.
   * @param data Path and style definition for the line.
   */
