...
export default () => {
  ...
  // Get the main theme style within the specified slide，And sorted by the proportion of
  ...
  // Get the main color in the specified slide（Ignore transparency），And sort by color area
  ...
  // Create a correspondence table between the original color and the new color
