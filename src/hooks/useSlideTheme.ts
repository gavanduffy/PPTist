...
export default () => {
  ...
  // Determine the dominant theme styles within the given slides and sort by area
  ...
  // Gather the primary colors used in a slide (ignoring transparency) and sort by area
  ...
  // Build a mapping between original colors and the new theme colors
  ...
  // Apply the current theme settings to every slide
