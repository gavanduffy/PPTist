  ...
  >
    ...
    >
      ...
      >
        ...
        <!-- When the font size is too large and the line height is small，There will be a situation where the text height overflows，As a result, the drag area cannot be selected，Therefore, the following nodes are added to avoid this situation -->
...
// Monitor size changes of text elements，when altitude changes，Update height tovuex
// If the height changes while the zoom operation is in progress，Then wait for the zoom operation to complete before updating
