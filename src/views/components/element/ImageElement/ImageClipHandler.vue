...
// Get cropping area information（The proportion of the cropped area to the width and height of the original image，at the position in the original image）
...
// The position and size of the underlying image（Mask area picture）
...
// Underlying image position size style（Mask area picture）
...
// The position and size of the top-level image container（Crop highlighted area）
...
// Top-level image container position size style（Crop highlighted area）
...
// Top-level image position size style（Crop area image）
...
// Initialize cropping position information
...
// Perform cropping：Calculate the position, size and cropping information of the cropped image，and sync the data out
const handleClip = () => {
...
// Shortcut key monitoring：Press Enter to confirm cropping
