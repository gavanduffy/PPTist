<template>
  <div class="element-positopn-panel">
    ...
    <ButtonGroup class="row">
      <Button style="flex: 1;" @click="orderElement(handleElement!, ElementOrderCommands.TOP)"><IconSendToBack /> pin to top</Button>
      <Button style="flex: 1;" @click="orderElement(handleElement!, ElementOrderCommands.BOTTOM)"><IconBringToFrontOne /> bottom</Button>
    </ButtonGroup>
    <ButtonGroup class="row">
      <Button style="flex: 1;" @click="orderElement(handleElement!, ElementOrderCommands.UP)"><IconBringToFront /> move up</Button>
      <Button style="flex: 1;" @click="orderElement(handleElement!, ElementOrderCommands.DOWN)"><IconSentToBack /> move down</Button>
    </ButtonGroup>
    ...
    <ButtonGroup class="row">
      <Button style="flex: 1;" v-tooltip="'left aligned'" @click="alignElementToCanvas(ElementAlignCommands.LEFT)"><IconAlignLeft /></Button>
...
// Set element width、high、rotation angle
// When setting the width and height of a shape，Need to check if shape path needs to be updated
...
// rotate element45Spend（clockwise or counterclockwise）
