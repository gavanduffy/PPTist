<template>
  <div class="table-style-panel">
    ...
    <div class="row">
      <div style="width: 40%;">Number of lines：</div>
...
// Update the text style status of the currently selected cell
...
// Update table theme：theme color、title row、summary row、first column、last column
