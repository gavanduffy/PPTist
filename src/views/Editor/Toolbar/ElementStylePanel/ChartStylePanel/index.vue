<template>
  <div class="chart-style-panel">
    ...
    <div class="row">
      <div style="width: 40%;">Theme color matching：</div>
      <Popover trigger="click" v-model:value="themesVisible" style="width: 60%;">
        <template #content>
          <div class="themes">
            ...
            <Divider :margin="10" />
            <Button class="full-width-btn" @click="themesVisible = false; themeColorsSettingVisible = true">Custom color matching</Button>
          </div>
        </template>
