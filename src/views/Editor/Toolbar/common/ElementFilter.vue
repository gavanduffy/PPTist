...
const defaultFilters: FilterOption[] = [
  { label: 'Vague', key: 'blur', default: 0, value: 0, unit: 'px', max: 10, step: 1 },
  ...
  { label: 'brown', key: 'sepia', default: 0, value: 0, unit: '%', max: 100, step: 5 },
  { label: 'reverse', key: 'invert', default: 0, value: 0, unit: '%', max: 100, step: 5 },
...
const presetFilters: {
  ...
  { label: 'bright', values: { 'saturate': '200%' } },
  { label: 'Vague', values: { 'blur': '2px' } },
  { label: 'reverse', values: { 'invert': '100%' } },
]
...
// Convert filter configuration tocss
