...
const elementTabs = [
  ...
  { label: 'Location', key: ToolbarStates.EL_POSITION },
...
const multiSelectTabs = [
  { label: 'style（Multiple choice）', key: ToolbarStates.MULTI_STYLE },
  { label: 'Location（Multiple choice）', key: ToolbarStates.MULTI_POSITION },
]
