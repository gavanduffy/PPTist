<template>
  <div class="slide-design-panel">
    ...
    <div class="background-gradient-wrapper" v-if="background.type === 'gradient'">
      ...
      <div class="row">
        <div style="width: 40%;">Current Swatch:</div>
      ...
      >
        <div class="theme-item-content">
          ...
          <div class="btns">
            ...
            <Button type="primary" size="small" style="margin-top: 3px;" @click="applyPresetTheme(item, true)">Apply and Use</Button>
          </div>
        </div>
      </div>
    </div>
...
// Set background mode: solid, image, or gradient
...
// Apply the current slide background to every slide
