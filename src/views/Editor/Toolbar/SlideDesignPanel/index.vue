<template>
  <div class="slide-design-panel">
    ...
    <div class="row">
      <Button style="flex: 1;" @click="applyBackgroundAllSlide()"><IconCheck /> Apply background to all</Button>
    </div>
    ...
    <div class="row">
      <Button style="flex: 1;" @click="applyFontToAllSlides(theme.fontName)"><IconCheck /> Global unified font</Button>
    </div>

    <div class="row">
      <Button style="flex: 1;" @click="themeStylesExtractVisible = true"><IconPlatte /> Extract topics from slides</Button>
    </div>
    ...
    <div class="theme-list">
      ...
      >
        <div class="theme-item-content">
          ...
          <div class="btns">
            <Button type="primary" size="small" @click="applyPresetTheme(item)">set up</Button>
            <Button type="primary" size="small" style="margin-top: 3px;" @click="applyPresetTheme(item, true)">Set up and apply</Button>
          </div>
        </div>
      </div>
    </div>
...
// Set background mode：solid color、picture、gradient color
