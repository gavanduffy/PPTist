  ...
  <div class="theme-styles-extract">
    ...
    <div class="content">
      ...
      <div class="config-item" v-if="themeStyles.themeColors.length">
        <div class="label">Theme Colors: <span class="tip">(Click color blocks to exclude unwanted colors)</span></div>
    ...
    <div class="btns">
      <Button class="btn" type="primary" @click="updateAllThemes()"><IconCheck /> Save Selected Config as Theme</Button>
    </div>
  </div>
</template>
...
const updateAllThemes = () => {
  ...
  if (themeColors.length > 6) {
    ...
    message.warning('Theme colors exceed the limit, automatically selected the first 6')
  }
