<template>
  <div class="theme-styles-extract">
    ...
    <div class="btns">
      <Button class="btn" type="primary" @click="updateAllThemes()"><IconCheck /> Save selected configuration as theme</Button>
    </div>
  </div>
</template>
...
const updateAllThemes = () => {
  ...
  if (themeColors.length > 6) {
    ...
    message.warning('Theme color exceeds quantity limit，Before automatically selected6indivual')
  }
