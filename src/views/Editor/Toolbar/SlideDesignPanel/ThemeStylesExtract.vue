  ...
  <div class="theme-styles-extract">
    ...
    <div class="content">
      ...
      <div class="config-item" v-if="themeStyles.themeColors.length">
        <div class="label">Theme Colors:<span class="tip"> (click a swatch to exclude it)</span></div>
    ...
    <div class="btns">
      <Button class="btn" type="primary" @click="updateAllThemes()"><IconCheck /> Save Selected Settings to Theme</Button>
    </div>
  </div>
</template>
...
const updateAllThemes = () => {
  ...
  if (themeColors.length > 6) {
    ...
    message.warning('Theme colors exceed the limit; keeping the first six automatically')
  }
