    ...
    <div class="configs">
      ...
      <div class="row">
        ...
        <div class="config-item">
          <Switch v-model:value="ignoreWebfont" v-tooltip="'Online fonts are ignored by default when exporting，If you use online fonts in your slides，And hope to retain relevant styles after exporting，Optionally close【Ignore online fonts】Options，But be aware that this will increase the export time。'" />
        </div>
      </div>
    </div>

    <div class="btns">
      <Button class="btn export" type="primary" @click="expImage()"><IconDownload /> Export pictures</Button>
