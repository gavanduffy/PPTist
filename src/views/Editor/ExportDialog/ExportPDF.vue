<template>
  <div class="export-pdf-dialog">
    ...
    <div class="configs">
      ...
      <div class="tip">
        hint：If the print preview is inconsistent with the actual style，Please check the box in the pop-up print window【background graphics】Options。
      </div>
    </div>

    <div class="btns">
      <Button class="btn export" type="primary" @click="expPDF()"><IconDownload /> Print / Export PDF</Button>
