    ...
    <div class="configs">
      ...
      <div class="row">
        ...
        <div class="config-item">
          <Switch v-model:value="ignoreMedia" v-tooltip="'Audio and video are ignored by default when exporting，If there are audio and video elements in your slides，and want to export it toPPTXin file，Optionally close【Ignore audio and video】Options，But be aware that this will significantly increase the export time。'" />
        </div>
      </div>
      <div class="row">
      ...
      <div class="tip" v-if="!ignoreMedia">
        hint：1. Support export format：avi、mp4、mov、wmv、mp3、wav；2. Cross-domain resources cannot be exported。
      </div>
    </div>
    <div class="btns">
      <Button class="btn export" type="primary" @click="exportPPTX(selectedSlides, masterOverwrite, ignoreMedia)"><IconDownload /> Export PPTX</Button>
