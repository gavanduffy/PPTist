<template>
  <div class="export-pptist-dialog">
    <div class="configs">
      ...
      <div class="tip">
        hint：.pptist Is the unique file suffix of this application，Supports importing files of this type back into the application。
      </div>
    </div>
    <div class="btns">
      <Button class="btn export" type="primary" @click="exportSpecificFile(selectedSlides)"><IconDownload /> Export PPTIST document</Button>
