<template>
  <div class="table-generator">
    <div class="title">
      ...
      <div class="right" @click="isCustom = !isCustom">{{ isCustom ? 'return' : 'Customize'}}</div>
    </div>
    <table 
      @mouseleave="endCell = []" 
    ...
    <div class="custom" v-else>
      <div class="row">
        <div class="label" style="width: 25%;">Number of lines：</div>
        <NumberInput
          :min="1"
          :max="20"
      ...
      <div class="row">
        <div class="label" style="width: 25%;">Number of columns：</div>
        <NumberInput
          :min="1"
          :max="20"
...
const insertCustomTable = () => {
  if (customRow.value < 1 || customRow.value > 20) return message.warning('Number of lines/The number of columns must be within0~20between！')
  if (customCol.value < 1 || customCol.value > 20) return message.warning('Number of lines/The number of columns must be within0~20between！')
