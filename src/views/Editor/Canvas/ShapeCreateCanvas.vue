...
onMounted(() => {
  message.success('Click to draw any shape，Close the beginning and end to complete the drawing，according to ESC key or right mouse button to cancel，according to ENTER Key completed ahead of time', {
    duration: 0,
  })
