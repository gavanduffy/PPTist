...
export default (elementList: Ref<PPTElement[]>) => {
  ...
  const dragLineElement = (e: MouseEvent, element: PPTLineElement, command: OperateLineHandlers) => {
    ...
    // Get all unrotated elements other than lines8zoom point as snap position
    ...
    document.onmousemove = e => {
      ...
      // The position of the starting and ending points of the line in the editing area
      ...
      // Drag the start or end position
      // Adsorption in horizontal and vertical directions
      ...
      // Calculate and update the coordinates of the starting point and end point based on the position of the own element
