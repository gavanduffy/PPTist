...
export default (viewportRef: ShallowRef<HTMLElement | null>) => {
  ...
  // The starting point and end point when selecting by mouse box，Calculate the location size of the selection
  ...
  // The starting point and end point when selecting by mouse box，Calculate the position, starting point and end point of the line in the canvas
  ...
  // Insert elements based on the position and size of the mouse selection
