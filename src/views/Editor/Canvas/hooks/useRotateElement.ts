...
export default (
  ...
  const rotateElement = (e: MouseEvent | TouchEvent, element: Exclude<PPTElement, PPTChartElement | PPTLineElement | PPTVideoElement | PPTAudioElement>) => {
    ...
    const handleMousemove = (e: MouseEvent | TouchEvent) => {
      ...
      // Calculate the angle of the current mouse position relative to the line connecting the center points of the element（radian）
      ...
      // near45There is an adsorption effect at multiple angles
