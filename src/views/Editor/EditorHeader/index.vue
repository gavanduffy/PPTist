<template>
  <div class="editor-header">
    <div class="left">
      <Popover trigger="click" placement="bottom-start" v-model:value="mainMenuVisible">
        <template #content>
          <div class="main-menu">
            <div class="ai-menu" @click="openAIPPTDialog(); mainMenuVisible = false">
              ...
              <div class="aippt-content">
                ...
                <div class="aippt-subtitle">Generate presentations with AI</div>
              </div>
            </div>
          </div>
          <Divider :margin="10" />
          ...
          <PopoverMenuItem class="popover-menu-item" @click="mainMenuVisible = false; hotkeyDrawerVisible = true"><IconCommand class="icon" /> Shortcuts</PopoverMenuItem>
          ...
          <Divider :margin="10" />
          <div class="statement">Note: This site is for testing/demo purposes only and does not provide any form of service</div>
        </template>
    ...
    <div class="right">
      ...
      <div class="menu-item" v-tooltip="'Generate PPT with AI'" @click="openAIPPTDialog(); mainMenuVisible = false">
